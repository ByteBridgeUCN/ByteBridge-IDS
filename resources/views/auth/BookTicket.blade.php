            ...
            <button id="confirmButton" type="submit" class="button">
                ...
                <svg class="button__svg" role="presentational" viewBox="0 0 600 600">
                  ...
                  <g clip-path="url(#myClip)">
                    ...
                    <g id="creditcard">
                      <path d="M372.12,181.59H210.9c-4.64,0-8.45,4.34-8.58,9.83l.85,278.17,177.49,2V191.42C380.55,185.94,376.75,181.57,372.12,181.59Z" fill="#0A74DA" stroke="#323c44" stroke-miterlimit="10" stroke-width="14" />
